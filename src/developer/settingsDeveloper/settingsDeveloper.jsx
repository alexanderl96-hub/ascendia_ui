...
//      const { userId , username, accountNumber, safeFetch, buyingPower, equity,  userEmail, fullName, cashBalance, totalEquity, modeTheme } = useAuth()
//   // Replace with your real user from context
//    const nav = useNavigate()
//   const initials = useMemo(() => initialsFromName(fullName), [fullName]);
//    console.log("modeTheme: ", modeTheme)
// //   const [theme, setTheme] = useState(modeTheme || "light"); // light | dark | system
//   const [theme, setTheme] = useState(() => {
//     // 1) localStorage wins if present
//     const saved = localStorage.getItem("modeTheme");
//     return saved ?? modeTheme ?? "light";
//     });
...
//   if (theme === "light") {
//     root.classList.remove("theme-dark");     // default theme
//   } else if (theme === "dark") {
//     root.classList.add("theme-dark");        // force dark
//   } else {
//     // do nothing (leave current theme class as-is)
//   }
// }, [theme]);
...
//     // 3) apply the theme class (always remove first)
//     useEffect(() => {
...
//     // 4) persist any change
//     useEffect(() => {
//     localStorage.setItem("modeTheme", theme);
//     }, [theme]);
...
//    useEffect(() => {
//     const saved = localStorage.getItem("ascendia.theme");
//     if (saved) setTheme(saved);
//     }, []);

//   useEffect(() => {
//     localStorage.setItem("ascendia.theme", theme);
//     }, [theme]);
...
//                 {/* <a className="back" href="/developer_home"> */}
...
//                         Customize how Ascendia looks on your device
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   <label className={`themeRow ${theme === "light" ? "themeRow--on" : ""}`}>
//                     <input
//                       type="radio"
//                       name="theme"
//                       checked={theme === "light"}
...
//                   <label className={`themeRow ${theme === "dark" ? "themeRow--on" : ""}`}>
//                     <input
//                       type="radio"
//                       name="theme"
//                       checked={theme === "dark"}
...
//                   <label className={`themeRow ${theme === "system" ? "themeRow--on" : ""}`}>
//                     <input
//                       type="radio"
//                       name="theme"
