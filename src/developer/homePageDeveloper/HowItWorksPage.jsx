...
import PricingPlanDev from "../pricingDeveloper/pricingPlanDev";

export default function HowItWorksPage() {
   const nav = useNavigate();
  const { userId , username, accountNumber, safeFetch, 
    buyingPower, equity,  userEmail, fullName, 
    cashBalance, totalEquity, userSubscriptionStatus, logout } = useAuth() 
    ...
    <div className="page">
        ...
        <div className="topbar_dev__inner">
          ...
          <nav className="nav">
            ...
            <Link className="nav__link" 
                  ...
                  onClick={() => handelTransition("Pricing")}>
               Pricing
            </Link>
          </nav>
            ...
            {menuOpen && (
                    <div className="menu">
                        ...
                        <button className="menu__item"  onClick={() => handelTransition("Dashboard")}>
                            <span className="menu__icon"  onClick={() => handelTransition("Dashboard")}>
                              <Icon name="user"  onClick={() => handelTransition("Dashboard")}/>
                            </span>
                            Dashboard
                        </button>
      ...
      {openPricing && 
        <PricingPlanDev 
            ...
            // onSelectPlan={(userSubscriptionStatus) => userSubscriptionStatus}
            onSelectPlan={userSubscriptionStatus}
            />
      }
      {openSetting && 
        <SettingsDeveloper 
